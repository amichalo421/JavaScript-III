...
//GameObject "destroy" prototype:
  GameObject.prototype.destroy = function(character) {
...
//CharacterStats "takeDamage()" prototype:
  CharacterStats.prototype.takeDamage = function() {
    return '${this.name} took damage.';
  };
//CharacterStats inherit "destroy()" prototype:
...
//Humanoid Constructor:
  function Humanoid(attrs) {
    CharacterStats.call(this, attrs); //doesn't need to inherit object because it is transitively passed through CharacterStats
    this.team = attrs.team;
    this.weapons = attrs.weapons;
    this.language = attrs.language;
  };
//Humanoid "greet" prototype:
Humanoid.prototype.greet = function() {
  return `${this.name} offers a greeting in ${this.language}.`;
};
//Humanoid inherit "destroy()" prototype:
Humanoid.prototype = Object.create(GameObject.prototype);

//Humanoid inherit "takeDamage()" prototype:
